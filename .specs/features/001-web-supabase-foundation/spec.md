...
| --- | --- | --- | --- |
| FOUND-01 | P1: Reproducible full-stack startup | Execute | Partially repaired (T21 complete; T22 pending) |
...
| FOUND-04 | P1: Production operations contract | Verify | Needs Fix (T23-T24) |
