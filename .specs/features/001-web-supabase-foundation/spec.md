...
| --- | --- | --- | --- |
| FOUND-01 | P1: Reproducible full-stack startup | Execute | In Progress (T8-T10 complete; T13-T14 pending) |
...
| FOUND-04 | P1: Production operations contract | Execute | In Progress (T8-T10 complete; T11 and T15-T16 pending) |
